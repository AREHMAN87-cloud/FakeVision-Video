    ...
    <div className="page">
      <div className="container">
        ...
        <p className="page-subtitle">
          Upload a video (mp4, mov, webm) for frame-by-frame deepfake analysis.
        </p>
        ...
        {!analyzing && !result && (
          <>
            <UploadArea
              ...
              title="Drag & drop a video"
              subtitle="or click to browse from your computer"
              formats="MP4, MOV, WEBM up to 100MB"
        ...
        {analyzing && (
          <div className="analysis-overlay">
            ...
            <p className="analysis-eta">This usually takes 1-2 minutes depending on video length.</p>
          </div>
        )}
